    ...
    final List<Map<String, String>> faqItems = [
      {
        ...
        'answer': '''Facilities you get when staying at Nestify:
1) Clean Linen
2) Clean Bathroom
3) Amenities
4) TV
...
6) Mineral Water''',
      ...
      {
        'question': 'How to book Nestify property?',
        'answer':
            'Booking can be made through website www.Nestify.com or mobile app which can be downloaded in Play Store.',
      },
      {
        'question':
